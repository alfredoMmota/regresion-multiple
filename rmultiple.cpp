//programa para el calculo de la regresion multiple Version 1.0
#include "rmultiple.h"
    ...
    ui(new Ui::rmultiple)
{
    ui->setupUi(this);//se conectan los botones de la interfaz con el programa
                      //the interface buttons are connected to the program
...
void rmultiple::calcular(){//se define la funcion calcular
    ...
    QString resultado,valor1,valor2,valor3,valor4,valor5,valor6,valor7;//se crean variables de tipo cadena
                                                                       //string type variables are created
    ...
    double multiple[6][3];//se declara la matriz y se agregan los valores de los spinbox a la matriz multiple
                          //the matrix is ​​declared and the values ​​of the spinbox are added to the multiple matrix
    ...
    //all the values ​​to be used in the method are calculated
    ...
    A[0][0]=n;//se agregan los valores obtenidos anteriormente en la matriz A
              //we add the values ​​obtained previously in matrix A
    A[1][0]=sumaX1;
    A[2][0]=sumaX2;
    A[0][1]=sumaX1;
    A[1][1]=X1cuadrado;
    ...
    double B[3][1];//se declara y agrengan los valores a la matriz B
                   //the values ​​are declared and agrengan to the matrix B
    B[0][0]=sumaY1;
    B[1][0]=X1Y1producto;
    B[2][0]=X2Y1pruducto;
    //se determinan los valores de las determinantes mediante el metodo de Crammer
    //the values ​​of the determinants are determined by the method of Crammer
    ...
    //the values ​​of a0, a1, a2 and the errors are determined
    ...
    //the sum of the least squares and the error for each of the values
    for(int i=0;i<n;i++){
    ...
    //are added the values ​​and legends that will have the result
